...
> do chính code của repo sinh ra trên `stripe-sample.csv` — bản trích 48 dòng của file thật, **đã gỡ khỏi repo**. Cách ánh xạ dưới đây không đổi; tổng số hiện tại của cả file xem `docs/DEVELOPER_GUIDE.md` §10.2.
>
